...
! --- DEFINE NAMES OF SOLAR PARAMETERS
      ...
      NPHASE = 0
      IF( IFPHASE )THEN
         IF ( F_RTPHASE .OR. F_KB_EPHS ) THEN
            WRITE(*,*) 'RT.PHASE = T. THE EMIRICAL PHASE FUNCTION IS RETRIEVED OR ENABLED IN THE KB SECTION. THEREFORE SWITCH OFF THE PHASE RERIEVAL.'
            WRITE(16,*) 'RT.PHASE = T. THE EMIRICAL PHASE FUNCTION IS RETRIEVED OR ENABLED IN THE KB SECTION. THEREFORE SWITCH OFF THE PHASE RERIEVAL.'
            CALL SHUTDOWN()
            STOP 1
         END IF
         DO I = 1, NBAND
