...
! NOV 2014 UPDATED FROM HITRAN RELEASE VERSION TIPS_2009 to TIPS_2011
...
! 1     H2O
      DATA (ISO82(1,J),J=1,6)/ 161,181,171,162,182,172/

! 2     CO2
      DATA (ISO82(2,J),J=1,11)/626,636,628,627,638,637,828,728,727,838,837/
...
! 5     CO
      DATA (ISO82(5,J),J=1,6)/26,36,28,27,38,37/

! 6    CH4
      DATA (ISO82(6,J),J=1,4)/211,311,212,312/

! 7     O2
      DATA (ISO82(7,J),J=1,3)/66,68,67/
...
!12     HNO3
      DATA (ISO82(12,J),J=1,1)/146/

!13     OH
      DATA (ISO82(13,J),J=1,3)/61,81,62/

!14     HF
      DATA (ISO82(14,J),J=1,1)/19/

!15     HCL
      DATA (ISO82(15,J),J=1,2)/15,17/

!16     HBR
      DATA (ISO82(16,J),J=1,2)/19,11/

!17     HI
      DATA (ISO82(17,J),J=1,1)/17/
...
!40     CH3BR
      DATA (ISO82(41,J),J=1,4)/2124,2134,3124,3134/

!42     CF4
      DATA (ISO82(42,J),J=1,1)/29/

!43     C4H2
      DATA (ISO82(43,J),J=1,1)/1221/

!44     HC3N
      DATA (ISO82(44,J),J=1,6)/12224,12234,12324,13224,12225,22224/

!45     C2N2
      DATA (ISO82(45,J),J=1,2)/4224,5225/

!46     CS
      DATA (ISO82(46,J),J=1,4)/22,24,32,23/

!47     H2
      DATA (ISO82(47,J),J=1,2)/11,12/

!48     SO
      DATA (ISO82(48,J),J=1,3)/26,46,28/

!49     C3H4
      DATA (ISO82(49,J),J=1,1)/1221/

!50     CH3
      DATA (ISO82(50,J),J=1,1)/2111/

!51     CS2
      DATA (ISO82(51,J),J=1,4)/222,224,223,232/
...
!  BD-QT
   ...
   SUBROUTINE BD_TIPS_2011( MOL, TEMP, ISO, GI, QT )
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(3) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(3), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01

      DATA XGJ/ 1.,1.,1.,6.,6.,1.,1.,6.,6.,6.,36.,1.,1.,6.,6.,36.,1.,6./
...
!
!     *****************
      Subroutine QT_N2O  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(4) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(4), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(5) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(5), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_CH4  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(6) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(6), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(7) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(7), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(8) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(8), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_SO2  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(9) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(9), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_NO2  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(10) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(10), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_NH3 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(11) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(11), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HNO3  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(12) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(12), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(13) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(13), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(14) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(14), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HCl ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(15) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(15), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HBr ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(16) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(16), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(17) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(17), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_ClO  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(18) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(18), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_OCS  ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(19) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(19), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_H2CO ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(20) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(20), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HOCl ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(21) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(21), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(22) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(22), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HCN ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(23) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(23), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_CH3Cl ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(24) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(24), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_H2O2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(25) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(25), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )           :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_C2H2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(26) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(26), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_C2H6 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(27) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(27), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_PH3 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(28) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(28), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_COF2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(29) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(29), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_SF6 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(30) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(30), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_H2S ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(31) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(31), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HCOOH ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(32) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(32), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HO2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(33) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(33), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(34) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(34), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_ClONO2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(35) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(35), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_NOp ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(36) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(36), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_HOBr ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(37) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(37), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!
!     *****************
      Subroutine QT_C2H4 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(38) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(38), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
      !REAL(DOUBLE) :: EPS = 0.01
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(40) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(40), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_CH3CN ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(41) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(41), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_CF4 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(42) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(42), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_C4H2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(43) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(43), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_HC3N ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(44) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(44), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_C2N2 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(45) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(45), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(46) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(46), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(47) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(47), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!     *****************
      ...
      REAL(DOUBLE), DIMENSION( ISONM(48) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(48), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_C3H4 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(49) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(49), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_CH3 ( T, ISO, GSI, QT )
      ...
      REAL(DOUBLE), DIMENSION( ISONM(50) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(50), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!
!     *****************
      Subroutine QT_CS2 ( T, ISO, GSI, QT )

      IMPLICIT NONE

      INTEGER, INTENT(IN)        :: ISO ! isotope code (HITRAN INDEX)
      REAL(DOUBLE), INTENT(IN)   :: T   ! temperature in K
      REAL(DOUBLE), INTENT(OUT)  :: GSI ! state independent nuclear degeneracyfactor
      REAL(DOUBLE), INTENT(OUT)  :: QT  ! Total Internal Partition Function

      INTEGER                    :: I, J

      REAL(DOUBLE), DIMENSION( ISONM(51) )     :: XGJ
      REAL(DOUBLE), DIMENSION( ISONM(51), NT ) :: QOFT
      REAL(DOUBLE), DIMENSION( NT )            :: Q
...
!...A variable, the routine will find the !orresponding bb value
!
!...input:  aa
!...output: bb
      ...
      !REAL(DOUBLE), dimension(NMAX)  :: A, B
      REAL(DOUBLE), dimension(NPT)   :: A, B

      INTEGER      :: I, J
      REAL(DOUBLE) :: A0D1, A0D2, A0D3, A1D1, A1D2, A1D3, A2D1, A2D2, A2D3, A3D1, A3D2, A3D3, A0, A1, A2, A3
...
!
   ...
   50 CONTINUE
  100 CONTINUE
!!!      write(2,*) 'F1, F2, F3, H1, H2, H3 =',B(J-2),B(J-1),B(J), &
!!!     + A(J-2), A(J-1), A(J)
!!!      write(2,*) 'A0, A1, A2, bb =',A0,A1,A2,bb
!
      RETURN
      END
