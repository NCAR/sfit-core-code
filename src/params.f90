...
!      CHARACTER(len=10) :: BUILDDATE = BDATE
      CHARACTER (LEN=15),  PARAMETER :: VERSION1 = 'SFIT4:v0.10.0.1'
      CHARACTER (LEN=100),  PARAMETER :: VERSION2 = ':Pre-Release -- Dezember 2016'
...
!      LOGICAL, PARAMETER :: ANALYTIC_K = .FALSE.
      ...
      INTEGER, PARAMETER :: NMAX = 511            ! MAXIMUM NUMBER OF FITTING PARAMETERS
...
! Phys. Today Aug 2001
      ...
      REAL(DOUBLE), PARAMETER :: SCHMIT  = 2.6867775D+19     ! molec/cm^3 at 1 atm & 0ºC
