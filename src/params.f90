...
!      CHARACTER(len=10) :: BUILDDATE = BDATE
      CHARACTER (LEN=15),  PARAMETER :: VERSION1 = 'SFIT4:V0.9.4.3.5.'
      CHARACTER (LEN=100),  PARAMETER :: VERSION2 = ':Pre-Release -- May 2014'
...
!      LOGICAL, PARAMETER :: ANALYTIC_K = .FALSE.
      ...
      INTEGER, PARAMETER :: MOLMAX = 12           ! MAXIMUM NUMBER OF RETRIEVAL GASES
