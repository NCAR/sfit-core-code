...
!  - Make molecular data compatible with ATM20 (NH3 iso=1,2,3,5) as well as HIT16
!  - Add PH3 lines from ATM20 id #55
!
...
!  --- MOLECULES IN ATMOS ORDER
      ...
      DATA ((XMASS(JISO,IMOLM),JISO=1,NI),IMOLM=1,10)/ &
       ...
       64.D0,  66.D0,  65.D0, 9*0.D0,                                 & !SO2
       46.D0,  47.D0,  10*0.D0/                                         !NO2

      DATA ((XMASS(JISO,IMOLM),JISO=1,NI),IMOLM=11,20)/ &
       17.D0,  18.D0, 18.D0, 19.D0, 19.D0, 20.D0, 20.D0, 5*0.D0,      & !NH3 (ATM20 has 1,2,3,5) (HIT16 has 1,2)
