...
integer, parameter,private :: kr4 = selected_real_kind(6,37)       ! single precision real
integer, parameter,private:: kr8 = selected_real_kind(15,307)     ! double precision real

! Integer kinds

integer, parameter,private :: ki4 = selected_int_kind(9)           ! single precision integer
integer, parameter,private :: ki8 = selected_int_kind(18)          ! double precision integer

!Complex kinds

integer, parameter,private :: kc4 = kr4                            ! single precision complex
integer, parameter,private :: kc8 = kr8                            ! double precision complex
...
interface value1 ! Generic operator for converting a number string to a 
...
subroutine writeq_dr(unit,namestr,value1,fmt)
...
call writenum(value1,tempstr,fmt)
...
subroutine writeq_sr(unit,namestr,value1,fmt)
