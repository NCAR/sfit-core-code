...
305   FORMAT("  RETRIEVAL GAS # :",I3, " HAS IFOFF FLAG:", I3, " CREATING L1 REGULARIZATION MATRIX WITH LAMDA : ", ES10.2 )
306   FORMAT("  TEMPERATURE RETRIEVAL CREATING L1 REGULARIZATION MATRIX WITH LAMBDA : ", ES10.2 )
      ...
      SUBROUTINE MAKE_TPMATRIX(NL,ALTVEC_LOW,ALTVEC_MID, TPMAT)
        ...
        ! NL IS THE NUMBER OF ALTITUDE LAYERS,
        ! ALTVEC_LOW ARE THE LOWER BOUNDARIES OF Z,
        ! ALTVEC_BAR ARE THE MIDPOINTS OF OF Z,
        ! I.E. THE BOUNDARIES OF THE ALTITUDE GRID

        IMPLICIT NONE

        INTEGER,INTENT(IN) :: NL
        REAL(8),DIMENSION(NL+1),INTENT(IN) :: ALTVEC_LOW, ALTVEC_MID
        ...
        DMAT = 0.0D0
        DO I = 1,NL
           ALT_WIDTH = 2*(ALTVEC_MID(I) - ALTVEC_LOW(I))
