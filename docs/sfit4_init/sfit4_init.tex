...
{\ttfamily out.raytrace.type= 1: SA's only}

{\ttfamily out.raytrace.type = 2: Detailed output of the raytrace calculation}

{\ttfamily out.raytrace.type = 3: Old style output files: MIX, MS, PT} &
&
~
\\\hline
\end{supertabular}
